...
<h2 id="text1"></h2>
  ...
  <script>
    var love = setInterval(function(){
      ...
      var i = 0;
      var txt1 = "Hi there.....!  <<               Now I want to say something special to you. <<<                So , Please read everything carefully...!                                                                           > All I know right now is that you are a special person to me < You seem something Special to me.  <<                  As the days goes < you get closer to me....! <<                           I don't know the reason why your thoughts always resonates inside my mind...!                                                     > Everything about you is always intresting to me...!                     << Now am about to tell you something really really interesting                                                    > I love you soooooo much dear.                   << Ano tefe, mn malet indalebign balakim gn indemiwedish lingerish zm biye!                                                             >I Love you so much <Much much...... |                  <<<< A love from a weird programmer :) ";
      var speed = 50;
      typeWriter();
      function typeWriter() {
        if (i < txt1.length) {        
