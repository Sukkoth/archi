...
<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <a href="{{ route('services') }}".html" class="nav-item nav-link active" >Services</a>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item d-flex position-relative text-center h-100">
                    ...
                    <div class="service-text p-5">
                        <img class="mb-4" src="customs/img/icons/icon-6.png" alt="Icon">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item d-flex position-relative text-center h-100">
                    <img class="bg-img" src="customs/img/service-3.jpg" alt="">
                    <div class="service-text p-5">
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
            ...
            <h1 class="display-5 mb-4">Customers Who Trust Us And Our Services Said...</h1>
        </div>
        <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
            @forelse (App\Models\Testimonial::orderBy('created_at', 'DESC')->take(10)->get() as $testimony)
            <div class="testimonial-item text-center" data-dot="<img class='img-fluid' src='img/testimonial-1.jpg' alt=''>">
                <p class="fs-5">{{$testimony->testimony}}</p>
                <span class="text-primary">{{$testimony->fullName}}</span>
            </div>
            @empty
