...
<head>
    ...
    <!-- Favicon -->
    <link href="{{asset('customs/admin/img/favicon.ico')}}" rel="icon">
    ...
    <link href="{{asset('customs/admin/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css')}}" rel="stylesheet" />
